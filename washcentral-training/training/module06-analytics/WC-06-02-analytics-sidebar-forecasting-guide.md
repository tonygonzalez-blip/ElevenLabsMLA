...
12. Click **Forecasting**. **Expected:** four KPI tiles run across the top: **Next Month Forecast** ($248,400), **YTD Variance** (+2.4%), **Accuracy** (94%), and **Data Points** (18 months). The Forecast List card's toolbar carries **Export** and **+ New Record**, controls the dashboards do not have.
...
- The Forecasting **+ New Record** create form was not captured in this session, so its fields are not documented here: TBD — parked (PARKED-ITEMS.md #17; the create-form probe 404s). Do not click it while recording.
