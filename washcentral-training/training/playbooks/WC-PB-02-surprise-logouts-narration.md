...
- **Status:** **RENDERED (July 11, 2026)** — WashCentral New (`CDbF7Jxnv3azemv9dXMP`), eleven_v3, 44.1 kHz MP3. 8 blocks `WC-PB-02-s01.mp3`…`WC-PB-02-s08.mp3` + joined `WC-PB-02-full-narration-v1.0.mp3` (158.03s ≈ 2:38). Step duration = audio + 0.4 s. Per-step render seconds: s01 14.99 · s02 20.04 · s03 15.23 · s04 17.71 · s05 16.43 · s06 18.44 · s07 21.79 · s08 30.2.
